...
// CODE HERE
const last =(array,callback)=>callback(names[names.length-1])
...
contains(names,"hemali", result => { 
  if ( result == true){
  console.log("hemali is in the array")
  } else{
    console.log("hemali is not in the array")
  }
})
...
uniq(values, result => console.log("The new names array with all the duplicates iteams removed is [UNIQARRPARAM]",result))
...
// CODE HERE
let names1 = ['Hemali','Kids']
each(names1, (name,index) => {
...
addHundred = addingFactory(100)

console.log(addHundred(50))
console.log(addHundred(100))
